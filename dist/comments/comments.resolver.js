...
const comment_type_1 = require("./dto/comment.type");
...
let CommentsResolver = class CommentsResolver {
    ...
    async createComment(content, taskId, user) {
...
__decorate([
    (0, graphql_1.Query)(() => [comment_type_1.CommentType]),
...
__decorate([
    (0, graphql_1.Mutation)(() => comment_type_1.CommentType),
    __param(0, (0, graphql_1.Args)('content')),
    __param(1, (0, graphql_1.Args)('taskId')),
...
exports.CommentsResolver = CommentsResolver = __decorate([
    (0, graphql_1.Resolver)(() => comment_type_1.CommentType),
